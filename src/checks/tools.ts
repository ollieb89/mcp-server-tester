...
import { validateTools, ValidationIssue } from '../validator';
...
export async function runToolsCheck(client: MCPClient): Promise<ToolsCheckResult> {
  ...
  try {
    ...
    let status: ToolsCheckResult['status'] = 'pass';
